...
class ManageIncidentAsset extends FormBase {
  constructor() {
    super();
    let me = this;
  ...
  deleteAction(dataRow) {
    ...
    if(dataRow) {
      ...
      showPopupDanger(Constants.PopupHeaderDeleteRecord, `<span>Bạn có chắc chắn muốn xóa <b>sự cố ${dataRow.incidentCode}: ${dataRow.assetName} - ${dataRow.incidentType}</b> hay không?</span>`, deleteFunc.bind(me, dataRow.incidentCode));
    }
  ...
  editAction(dataRow) {
    let me = this;
    me.$dialog.find(".text-header").html("Chỉnh sửa thông tin sự cố");
    me.$dialog.show();
...
var oFormBase = new ManageIncidentAsset();
var app = this;
